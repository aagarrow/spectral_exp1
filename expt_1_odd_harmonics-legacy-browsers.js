/***************************** 
 * Expt_1_Odd_Harmonics *
 *****************************/


// store info about the experiment session:
let expName = 'expt_1_odd_harmonics';  // from the Builder filename that created this script
let expInfo = {
    '': '',
};
...
async function experimentInit() {
  ...
  const GCS_SOUNDS_URL = "https://storage.googleapis.com/acw709_test_bucket/sounds/";
  const GCS_CONDITIONS_URL = "https://storage.googleapis.com/acw709_test_bucket/conditions/";
